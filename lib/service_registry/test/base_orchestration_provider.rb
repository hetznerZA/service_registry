  ...
  module Test
    class BaseOrchestrationProvider
      def setup
        ...
        @contact_1 = { 'name' => 'Darren Silke', 'email' => 'darren@smooth-silk.com', 'description' => 'Intern', 'phone' => '0217881445'}
        @contact_2 = { 'name' => 'Tenashe Madzingaidzo', 'email' => 'tenashe@greatpasswords.net'}
