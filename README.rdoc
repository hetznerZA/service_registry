...
=== service definitions
* {registering services with their definition}[file:features/register_service_feature.html] when associating services with service components
* {updating service definitions}[file:features/register_service_feature.html] when associating services with service components
* {deregistering service definitions}[file:features/deregister_service_definition_feature.html] when service and service component associations should no longer be made
* {obtaining a service definition}[file:features/service_definition_feature.html] given a service identifier

=== accociations
* {associating service components with domain perspectives}[file:features/associate_service_component_with_domain_perspectve_feature.html] when modelling the domain.
* {changing associations}[file:features/associate_service_component_with_domain_perspective_feature.html] when modelling the domain.
* {removing associations}[file:features/remove_service_component_domain_perspective_association_feature.html] when modelling the domain.

=== services (TBD continue here)

* {finding a list of services in a domain perspectives}[file:features/service_search_feature.html] when discovering exploring a domain perspective
...
* {querying service status}[file:features/service_status_feature.html] when deciding which service from a pool of candidate services are best to use

== Requirements

The service requires:
* {bootstrapping with a configuration service}[file:features/bootstrap_with_configuration_service_feature.html]
* {bootstrapping with a globally unique identifier}[file:features/bootstrap_identifier_feature.html]
