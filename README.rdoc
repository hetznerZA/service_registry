...
* Not supported by design: {file:features/service_domain_perspective_association.readme associating services with domain perspectives} when modelling the domain.
* Not supported by design: {file:features/service_domain_perspective_association.readme changing domain perspective service associations} when modelling the domain.
* Not supported by design: {file:features/service_domain_perspective_association.readme removing domain perspective service associations} when modelling the domain.
