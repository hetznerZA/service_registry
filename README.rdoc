...
* Not supported by design: {file:features/service_domain_perspective_association.feature associating services with domain perspectives} when modelling the domain.
* Not supported by design: {file:features/service_domain_perspective_association.feature changing domain perspective service associations} when modelling the domain.
* Not supported by design: {file:features/service_domain_perspective_association.feature removing domain perspective service associations} when modelling the domain.
...
* {file:features/service_component_search.feature finding a list of service components in a domain perspectives} when exploring provisining of a domain perspective
...
for tfa and production, consider this API:
