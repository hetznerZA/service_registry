...
=== service definitions
* {file:features/register_service.feature registering services with their definition} when provisioning services
* {file:features/register_service.feature updating service definitions} when provisioning services
...
* {file:features/service_definitions_given_service_component.feature finding a list of services given a service component} when exploring service components
...
* {file:features/configuration.feature configuration} of the registry.
