...
* {obtaining service definitions}[file:features/service_definitions_given_service_component_feature.html] given a service component
...
* {querying service status}[file:features/service_search_feature.html] when deciding which service from a pool of candidate services are best to use
